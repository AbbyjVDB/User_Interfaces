// JavaScript code for the project corresponding to page2.html. Rename the file as per your project idea and make sure to include the author's name at the top in comments
...
function appendConsoles(data){
    let consoles = data.earlyConsoles;
